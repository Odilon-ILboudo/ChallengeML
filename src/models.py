    ...
    if problem_type == 'binary':
        ...
        models.update({
            ...
            'params_full': {
                ...
                'degree': [2, 3] # Seulement pour poly
            }
        }})
        ...
        models.update({
            'SVM': {
            'estimator': SVC(probability=True, decision_function_shape='ovr', random_state=42),
            'has_predict_proba': True,
            'params_light': {
                'C': [1, 10],
                'kernel': ['rbf']
        ...
        models.update({
            ...
            'estimator': XGBClassifier(
                objective='multi:softprob', # Force la sortie en probabilités
                eval_metric='mlogloss',     # Métrique multi-classe
        ...
        models.update({
            ...
            'estimator': CatBoostClassifier(
                loss_function='MultiClass', # Spécifique multi-classe
                verbose=0, 
                random_state=42, 
